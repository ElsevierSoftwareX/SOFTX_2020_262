...
surv_data_struct.Type(cellfun(@isempty,surv_data_struct.Type))={' '};
surv_data_struct.Stratum(cellfun(@isempty,surv_data_struct.Stratum))={' '};

surv_data_struct.Voyage=cell(nb_lines,1);
surv_data_struct.SurveyName=cell(nb_lines,1);

surv_data_struct.Voyage(:)=dbconn.fetch('select Voyage from survey');
