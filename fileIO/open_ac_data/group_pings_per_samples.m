...
group_by_nb_s=ceil(filter2(ones(1,nb_min_win),ceil(nb_samples/div_factor),'same')./...
    filter2(ones(1,nb_min_win),ones(size(pings)),'same'));
...
idx_new_group=unique([1 idx_change+1]);
