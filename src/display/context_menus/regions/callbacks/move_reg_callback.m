...
if ~(isa(obj,'matlab.graphics.primitive.Patch')||isa(obj,'matlab.graphics.primitive.Image')||isa(obj,'matlab.graphics.primitive.Polygon')) 
    return;
end
...
switch main_figure.SelectionType
    case 'normal'
        ...
        switch obj.Type
            ...
            case 'polygon'
                move_poly_select(obj,[],main_figure);
            case 'image'
