...
replace_interaction(main_figure,'interaction','WindowButtonUpFcn','id',2,'interaction_fcn',@wbucb,'pointer',curr_disp.get_pointer());
    ...
    function wbmcb(~,~)
        ...
        set(hp_p,'XData',idx_brush,'YData',bottom_idx(idx_brush)-1/2);
