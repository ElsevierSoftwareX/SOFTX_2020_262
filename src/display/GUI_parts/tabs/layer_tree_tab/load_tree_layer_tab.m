...
layer_tree_tab_comp.root_node = uitreenode('v0', [], 'Layers', fullfile(iconpath,'node_icon.gif'), false);
userdata.level='root';
layer_tree_tab_comp.root_node.UserData=userdata;
...
update_tree_layer_tab(main_figure,'surveydata');
