...
load_algo_panel('main_figure',main_figure,...
        'panel_h',uipanel(denoise_tab,'Units','Pixels','Position',[0 0 1.6*l h]),...
        'algo_name',algo_name,...
        'title','Denoise',...
        'save_fcn_bool',true);
    ...
    denoise_tab_comp.filtering_panel=uipanel(denoise_tab,'title','Notch Filtering (FM)','Units','Pixels','Position',[1.6*l 0 4*l h]);
