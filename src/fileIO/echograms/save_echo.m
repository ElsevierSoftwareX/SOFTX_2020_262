...
'geometry_x',echo_obj_existing.main_ax.UserData.geometry_x,...
'geometry_y',echo_obj_existing.main_ax.UserData.geometry_y,...
'pos_in_parent',[0 0 1 0.95]);

[dr,dp,up] =echo_obj.display_echogram(trans_obj,...
            'curr_disp',curr_disp,...
            'Fieldname',curr_disp.Fieldname,...
            'x',echo_obj_existing.echo_surf.UserData.Idx_pings,...
            'y',echo_obj_existing.echo_surf.UserData.Idx_r,...
            'off_disp',true,...
            'force_update',true);

echo_obj.main_ax.XLim = echo_obj_existing.main_ax.UserData.xlim;
echo_obj.main_ax.YLim = echo_obj_existing.main_ax.UserData.ylim;
