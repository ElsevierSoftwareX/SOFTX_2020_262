...
struct_in.mission_start_date=cellfun(@(x) datestr(x,'yyyy-mm-dd HH:MM:SS.FFF'),num2cell(struct_in.mission_start_date),'un',0);
struct_in.mission_end_date=cellfun(@(x) datestr(x,'yyyy-mm-dd HH:MM:SS.FFF'),num2cell(struct_in.mission_end_date),'un',0);
