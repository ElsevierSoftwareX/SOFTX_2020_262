...
if datatype(1)==dec2bin(1)
    if datatype(2)==dec2bin(1)||datatype(1)==dec2bin(0)&&trans_obj.Config.BeamType>0
        ...
        [AlongAngle,AcrossAngle]=computesPhasesAngles_v3(data_tmp,...
            trans_obj.Config.AngleSensitivityAlongship*trans_obj.Config.BeamWidthAlongship/faBW,...
            trans_obj.Config.AngleSensitivityAthwartship*trans_obj.Config.BeamWidthAthwartship/psBW,...
            datatype,...
