...
nb_samples=nanmax(trans_obj.Data.Nb_samples);
...
for i=idx_bad
    ...
    idx_ping_curr=curr_reg.Idx_ping;
    mask(idx_r_curr,idx_ping_curr)= mask_temp;
end
...
for i=idx_good
    ...
    idx_r_curr=curr_reg.Idx_r;
    idx_ping_curr=curr_reg.Idx_ping;
    mask(idx_r_curr,idx_ping_curr)= double(mask(idx_r_curr,idx_ping_curr)>0&mask_temp==0);
end
