...
% * |Vertical_slice_size|: Slice width (Optional. Positive num. Default: |10|).
...
addParameter(p,'Vertical_slice_size',10,@(x) x>0);
...
reg_sh = trans_obj.create_WC_region(...
    ...
    'y_min',0,...
    'Ref','Bottom',...
    'Cell_w',p.Results.Vertical_slice_size,...
...
output_reg = trans_obj.integrate_region(reg_sh,'timeBounds',[p.Results.StartTime p.Results.EndTime],...
...
% estimate height and slope of shadow zone
