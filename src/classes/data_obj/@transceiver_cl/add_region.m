...
for i=1:length(regions)
    ...
    regions(i)=trans_obj.validate_region(regions(i));
        ...
        vertices_1=unique(regions(i).Poly.Vertices(~isnan(regions(i).Poly.Vertices(:,1)),1));
       vertices_2=unique(regions(i).Poly.Vertices(~isnan(regions(i).Poly.Vertices(:,2)),2));
