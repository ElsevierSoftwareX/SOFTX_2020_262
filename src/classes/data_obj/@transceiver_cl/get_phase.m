...
AlongAngle=trans_obj.Data.get_subdatamat('idx_r',p.Results.idx_r,'idx_ping',p.Results.idx_ping,'field','alongangle');
AcrossAngle=trans_obj.Data.get_subdatamat('idx_r',p.Results.idx_r,'idx_ping',p.Results.idx_ping,'field','acrossangle');
