...
if ~isempty(echo_obj.echo_usrdata.Layer_ID)&&~isempty(echo_obj.echo_usrdata.Idx_r)
   if ~(idx_r_disp(1)>=echo_obj.echo_usrdata.Idx_r(1)&&idx_r_disp(end)<=echo_obj.echo_usrdata.Idx_r(end))||...
            ~(idx_p_disp(1)>=echo_obj.echo_usrdata.Idx_ping(1)&&idx_p_disp(end)<=echo_obj.echo_usrdata.Idx_ping(end))||...
            dr~=round(nanmean(diff(echo_obj.echo_usrdata.Idx_r)))|| dp~=round(nanmean(diff(echo_obj.echo_usrdata.Idx_ping)))||...
