classdef survey_options_cl
    properties
        ...
        Remove_tracks=0;
        Remove_ST=0;
        Export_ST=0;%0 for non export, 1 for ST export, 2 for TT export;
        Export_TT=0;
        Denoised=0;
        Frequency=38000;
        Channel='';
        FrequenciesToLoad=[];
        ChannelsToLoad=[];
        CopyBottomFromFrequency=0;
        CTD_profile='constant';
        SVP_profile='constant';
        Temperature=nan;
        Salinity=nan;
        Soundspeed=nan;
        MeanDepth=nan;
    ...
    methods
        function options=survey_options_cl(varargin)            
            ...
            addParameter(p,'Options',default_options,@isstruct);
            parse(p,varargin{:});
            ...
            if isfield(results.Options,'Frequency')
