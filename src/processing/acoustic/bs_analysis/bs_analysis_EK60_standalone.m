...
layer = open_EK_file_stdalone(Filename, ...
    'PathToMemmap', p.Results.PathToMemmap,Path, 'Frequencies', p.Results.Frequencies, 'Channels', p.Results.Channels,......
...
layer.set_EnvData(layer.EnvData.set_svp(z_c, c,'profile'));
