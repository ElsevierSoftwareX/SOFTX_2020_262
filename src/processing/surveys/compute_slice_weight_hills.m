...
for i=1:length(lat_e)
    start_r(i)=lat_long_to_km([lat0 lat_s(i)],[long0 long_s(i)])*1e3;%distance of start of slice from center in m
    
    end_r(i)=lat_long_to_km([lat0 lat_e(i)],[long0 long_e(i)])*1e3;%distance of end of slice from center in m
