...
idx_nan=output_reg_1.Sv_mean_lin(1:nanmin(N_x,N_x_2),1:nanmin(N_y,N_y_2))<=db2pow(-998)|output_reg_2.Sv_mean_lin(1:nanmin(N_x,N_x_2),1:nanmin(N_y,N_y_2))<=db2pow(-998);
...
output_diff.Sv_mean_lin(idx_nan)=0;
