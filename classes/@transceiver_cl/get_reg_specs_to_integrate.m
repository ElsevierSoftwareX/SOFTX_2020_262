...
idx_data=trans_obj.find_regions_type('Data');

if any(strcmp(IDs,''))||any(strcmp(names,''))
    reg_temp=trans_obj.get_reg_spec(idx_data);
    ...
    for i_sub_reg=1:length(IDs)
        ...
        idx_temp=intersect(idx_data,idx_temp);
