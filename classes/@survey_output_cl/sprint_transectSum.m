...
str=sprintf('\n# Transect Summary\n#snapshot type stratum transect dist vbscf abscf mean_d pings av_speed start_lat start_lon finish_lat finish_lon\n');
prec={'%0.f,' '%s,' '%s,' '%0.f,' '%0.4f,' '%.5e,' '%.5e,' '%0.3f,' '%0.f,' '%0.5f,' '%0.4f,' '%0.4f,' '%0.4f,' '%0.4f'};
