...
struct_out.transect_start_time=cellfun(@(x) datestr(x,'yyyy-mm-dd HH:MM:SS.FFF'),num2cell(struct_out.transect_start_time),'un',0);
struct_out.transect_end_time=cellfun(@(x) datestr(x,'yyyy-mm-dd HH:MM:SS.FFF'),num2cell(struct_out.transect_end_time),'un',0);
